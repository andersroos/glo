...
class Value extends  React.Component {
    ...
    render() {
        ...
        return (
            <tr><td>{this.props.value.key}</td><td>{this.props.value.value}</td><td>{this.props.value.computed}</td><td>{this.props.value.desc}</td></tr>
        );
    }
...
ReactDOM.render(React.createElement(Ui, {servers: [{key: 'test:1'}, {key:'test:2'}]}),
